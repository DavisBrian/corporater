...
R has two versions of a logical and (or) \texttt{\&} and \texttt{\&\&}
(\texttt{\textbar{}} and \texttt{\textbar{}\textbar{}}). The single
version is the vectorized version while the the double version returns a
length-one vector. Use the double version in logical control structures
(if, for, while, etc).
...
\hypertarget{basic-looping}{%
\section{Basic Looping}\label{basic-looping}}
