...
1.  Create a function that returns the latest (most recent) input file name for your data set.
1.  Extend the above to return a specific year-quarters data file.
...
1.  Create a function that does the reverse of the two above.  Ex. 2017Q4 or "2017 Q4" becomes a numeric 20174.
1. Create function that takes a character year-quater (ex 2018Q3) and the quarter n-quarters before it.  Example two quarters previous to 2018Q3 is 2018Q1.